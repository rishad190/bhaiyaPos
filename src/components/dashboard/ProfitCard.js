        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="weekly">
              <p className="text-2xl font-bold">{profitData.weekly}</p>
              <p className="text-xs text-muted-foreground">This week's profit</p>
            </TabsContent>
            <TabsContent value="monthly">
              <p className="text-2xl font-bold">{profitData.monthly}</p>
              <p className="text-xs text-muted-foreground">This month's profit</p>
            </TabsContent>
            <TabsContent value="yearly">
              <p className="text-2xl font-bold">{profitData.yearly}</p>
